...
## PPO简介
![Pasted image 20260812113014.png](附件/Pasted image 20260812113014.png)

>先回顾下 Policy Gradient 的计算过程。

![Pasted image 20260812131157.png](附件/Pasted image 20260812131157.png)
>$R(\tau^n)$我们称之为 Advantage Function，它的演化过程参考[RL Lecture](RL Lecture.md)。
...
![Pasted image 20260812140451.png](附件/Pasted image 20260812140451.png)
>但是这种替代不是完美的，他们的 Var 不同。

![Pasted image 20260812142146.png](附件/Pasted image 20260812142146.png)
![Pasted image 20260812142405.png](附件/Pasted image 20260812142405.png)
...
![Pasted image 20260812144448.png](附件/Pasted image 20260812144448.png)
...
![Pasted image 20260812151750.png](附件/Pasted image 20260812151750.png)
...
![Pasted image 20260812152814.png](附件/Pasted image 20260812152814.png)
>以下是 PPO 的一个变形，通过 clip 函数取代了 KL 散度。可以看到蓝色虚线代表后一项，绿色虚线代表前一项，最终我们取 min，得到红色线。本质上目标是约束$\theta$与$\theta_k$不能差别太大。

![Pasted image 20260812154035.png](附件/Pasted image 20260812154035.png)
PPO多用于 LLMs 的后训练中，这点可以在[RL ON LLMs](RL ON LLMs(From GPT)/RL ON LLMs.md)中了解，在
